...
> **v2.5** - 한국 주식 중심 대시보드 | Python 3.9+ | Streamlit

## 🔥 핵심 기능 (메인 대시보드)

| 기능 | 설명 |
|:---:|:---|
| 💬 **SNS 시장 토론** | 6명의 트레이더 페르소나가 현재 시장을 분석 |
| ❄️ **Snowflake 분석** | 5축 레이더 차트로 종목 특성 시각화 (전체 한국 주식 지원) |
| 🎯 **Catalyst 분석** | 잠재적 급등/급락 요인 사전 탐지 |
| 📈 **KOSPI/KOSDAQ** | 실시간 지수 및 캔들스틱 차트 |
| 💱 **환율** | USD/KRW 실시간 조회 |

## 🇰🇷 한국 주식 전용 기능

```
한국 시장 데이터: pykrx (무료, API 키 불필요)
├── 전종목 검색 및 분석
├── KOSPI/KOSDAQ 지수
├── 투자자별 매매동향
├── 배당 캘린더
└── 실시간 환율 (exchangerate-api.com)
```
