...
class KRXDataCollector:
    ...
    def _get_fallback_stock_list(self, market: str = 'ALL') -> pd.DataFrame:
        ...
        kospi_stocks = {
            ...
            **self.blue_chips,
            # 추가 KOSPI 종목
            '000100': 'DB손해보험', '000120': 'CJ대한통운', '000150': '두산',
            '000210': '대림산업', '000240': '한국타이어앤테크놀로지', '000270': '기아',
            '000660': 'SK하이닉스', '000720': '현대건설', '000810': '삼성화재',
            '000880': '한화', '001040': 'CJ', '001120': 'LG인화원',
            '001230': '동국제강', '001440': '대한전선', '001450': '현대해상',
            '001740': 'SK네트웍스', '002380': 'KCC', '002790': '아모레G',
            '003410': '쌍용C&E', '003490': '대한항공', '003550': 'LG',
            '003670': '포스코퓨처엠', '004020': '현대제철', '004170': '신세계',
            '004370': '농심', '004490': '세방전지', '004800': '효성',
            '004990': '롯데지주', '005250': '녹십자홀딩스', '005490': 'POSCO홀딩스',
            '005830': '동부화재', '005850': '에스엘', '005930': '삼성전자',
            '005940': 'NH투자증권', '006260': 'LS', '006360': 'GS건설',
            '006400': '삼성SDI', '006800': '미래에셋증권', '007070': 'GS리테일',
            '008060': '대덕전자', '008770': '호텔신라', '009150': '삼성전기',
            '009240': '한샘', '009540': '한국조선해양', '010060': 'OCI홀딩스',
            '010130': '고려아연', '010140': '삼성중공업', '010620': '현대미포조선',
            '010950': 'S-Oil', '011070': 'LG이노텍', '011170': '롯데케미칼',
            '011200': 'HMM', '011780': '금호석유', '012330': '현대모비스',
            '012450': '한화에어로스페이스', '015760': '한국전력', '016360': '삼성증권',
            '017670': 'SK텔레콤', '018260': '삼성에스디에스', '018880': '한온시스템',
            '020150': '일진머티리얼즈', '021240': '코웨이', '024110': '기업은행',
            '028050': '삼성엔지니어링', '028260': '삼성물산', '029780': '삼성카드',
            '030200': 'KT', '032640': 'LG유플러스', '033780': 'KT&G',
            '034020': '두산에너빌리티', '034220': 'LG디스플레이', '034730': 'SK',
            '035250': '강원랜드', '035420': 'NAVER', '035720': '카카오',
            '036460': '한국가스공사', '036570': 'NCsoft', '039490': '키움증권',
            '042660': '한화오션', '047040': '대우건설', '047050': '포스코인터내셔널',
            '051900': 'LG생활건강', '051910': 'LG화학', '055550': '신한지주',
            '066570': 'LG전자', '068270': '셀트리온', '069500': 'KODEX200',
            '071050': '한국금융지주', '078930': 'GS', '086280': '현대글로비스',
            '086790': '하나금융지주', '088350': '한화생명', '090430': '아모레퍼시픽',
            '096770': 'SK이노베이션', '097950': 'CJ제일제당', '105560': 'KB금융',
            '138040': '메리츠금융지주', '139480': '이마트', '161390': '한국타이어',
            '180640': '한진칼', '207940': '삼성바이오로직스', '267250': 'HD현대',
            '272210': '한화시스템', '302440': 'SK바이오사이언스', '316140': '우리금융지주',
            '323410': '카카오뱅크', '352820': '하이브', '373220': 'LG에너지솔루션',
            '377300': '카카오페이', '383220': 'F&F', '402340': 'SK스퀘어',
        }
        ...
        kosdaq_stocks = {
            ...
            '112040': '위메이드', '041960': '코미팜', '196170': '알테오젠',
            '145020': '휴젤', '328130': '루닛', '039030': '이오테크닉스',
            '058470': '리노공업', '086520': '에코프로', '247540': '에코프로비엠',
            '091990': '셀트리온헬스케어', '095340': 'ISC', '122870': '와이지엔터테인먼트',
            '131970': '테스나', '140860': '파크시스템스', '141080': '레고켐바이오',
            '145170': '인터로조', '214150': '클래시스', '214370': '케어젠',
            '226330': '신테카바이오', '237690': '에스티팜', '240810': '원익IPS',
            '241560': '두산밥캣', '263860': '지니언스', '278280': '천보',
            '290670': '대보마그네틱', '293780': '아프리카TV', '294090': '이오플로우',
            '298000': '효성티앤씨', '299030': '하나머티리얼즈', '299660': '심텍',
            '300720': '한일시멘트', '314930': '바이오에프디엔씨', '317330': '덕산테코피아',
            '330590': '롯데렌탈', '336260': '두산퓨얼셀', '336370': '솔루스첨단소재',
            '347860': '알체라', '357780': '솔브레인', '363280': '티와이홀딩스',
            '377190': '디앤씨미디어', '383310': '에코프로에이치엔', '394280': '오픈엣지테크놀로지',

            # 소형주/테마주
            '064260': '다날', '299900': '위지윅스튜디오', '032580': '피델릭스',
            '053080': '케이엔솔', '041020': '폴라리스오피스', '052770': '아이톡시',
            '060310': '3S', '067630': '에이치엘비생명과학', '078140': '대봉엘에스',
            '084370': '유진테크', '089010': '켐트로닉스', '094360': '칩스앤미디어',
            '095660': '네오위즈', '100120': '뷰웍스', '101490': '엘앤케이바이오',
            '108860': '셀바스AI', '114810': '한솔아이원스', '115310': '인베니아',
            '119860': '다나와', '122690': '서진오토모티브', '123040': '엠에스오토텍',
            '131290': '티에스이', '137950': '제이씨케미칼', '138580': '비즈니스온',
            '140410': '메지온', '143160': '아이디스', '145990': '삼양사',
            '148150': '세경하이테크', '149980': '하이로닉', '153460': '네이블',
            '161580': '필옵틱스', '166090': '하나머티리얼즈', '178320': '서진시스템',
            '182360': '큐브엔터', '183300': '코미코', '187790': '나노',
            '192080': '더블유게임즈', '194480': '데브시스터즈', '195870': '해성디에스',
            '204620': '글로벌텍스프리', '206650': '유바이오로직스', '211050': '인카금융서비스',
            '213420': '덕산네오룩스', '217190': '제너셈', '222080': '씨아이에스',
            '222800': '심텍홀딩스', '226400': 'OSB저축은행', '227840': '현대코퍼레이션',
            '228670': '레이', '234300': '에스티큐브', '237880': '클리오',
            '238090': '앤디포스', '243070': '휴온스', '246250': '에스엘에스바이오',
            '251970': '펌텍코리아', '253450': '스튜디오드래곤', '256940': '케이피에스',
            '256980': '오로스테크놀로지', '257720': '실리콘투', '258610': '에이티세미콘',
            '259630': '엠게임', '260930': '씨티케이', '263600': '덕우전자',
            '265520': 'AP시스템', '267260': '현대일렉트릭', '268280': '미원에스씨',
            '272110': '케이엔제이', '278990': 'EMB', '281740': '레이크머티리얼즈',
            '282880': '코윈테크', '285490': '노바텍', '290520': '신도기연',
            '298040': '효성중공업', '298380': '에이비엘바이오', '298690': '에이스테크',
            '307280': '원바이오젠', '317530': '캐리소프트', '321820': '와이더플래닛',
            '322000': '현대에너지솔루션', '330860': '네패스', '334890': '이지스밸류리츠',
            '341310': 'IAMD', '348210': '넥스틴', '352480': '씨앤씨인터내셔널',
            '357120': '코람코라이프인프라리츠', '359090': 'C&R연구소', '365340': '성일하이텍',
            '376300': '디어유', '389030': '지누스', '396270': '넥스트칩',
            '400760': '유안타제8호기업인수목적', '403550': '쏘카', '413630': '유진로봇',
        }

        data = []
        for code, name in kospi_stocks.items():
            data.append({'code': code, 'name': name, 'market': 'KOSPI'})
        for code, name in kosdaq_stocks.items():
            data.append({'code': code, 'name': name, 'market': 'KOSDAQ'})
